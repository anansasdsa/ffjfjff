...
client3.login(proccess.env.BOT_TOKEN3);
client4.login(proccess.env.BOT_TOKEN4);
client5.login(proccess.env.BOT_TOKEN5);
client6.login(proccess.env.BOT_TOKEN6);
client7.login(proccess.env.BOT_TOKEN7);
client8.login(proccess.env.BOT_TOKEN8);
client9.login(proccess.env.BOT_TOKEN9);
client10.login(prccess.env.BOT_TOKEN10);
